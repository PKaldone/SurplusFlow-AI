...
const STATUS_STYLES: Record<string, string> = {
  // Case statuses (portal-relevant subset)
...
/** Map raw status codes to friendly plain-English labels for claimants */
const FRIENDLY_LABELS: Record<string, string> = {
  OPPORTUNITY_IDENTIFIED: "Identified",
  OUTREACH_PENDING: "Reaching Out",
  OUTREACH_SENT: "Contacted",
  OUTREACH_RESPONDED: "In Touch",
  CLAIMANT_ENROLLED: "Enrolled",
  DOCS_COLLECTING: "Collecting Documents",
  COMPLIANCE_REVIEW: "Under Review",
  NEEDS_LEGAL_REVIEW: "Legal Review",
  CLAIM_READY: "Ready to File",
  CLAIM_FILED: "Claim Filed",
  CLAIM_PROCESSING: "Processing",
  PAYOUT_RECEIVED: "Payment Received",
  CLAIM_DENIED: "Denied",
  INVOICE_SENT: "Invoice Sent",
  FEE_COLLECTED: "Complete",
  CLOSED_COMPLETE: "Complete",
  CLOSED_CLAIMANT_WITHDREW: "Withdrawn",
  ENROLLED: "Enrolled",
  PACKET_ASSEMBLY: "Preparing Claim",
  SUBMITTED: "Claim Filed",
  AWAITING_PAYOUT: "Awaiting Payment",
  RECOVERED: "Recovered",
  INVOICED: "Invoiced",
  CLOSED: "Complete",
};
...
function formatLabel(status: string): string {
  if (FRIENDLY_LABELS[status]) return FRIENDLY_LABELS[status];
  return status
    .replace(/_/g, " ")
